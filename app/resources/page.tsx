...
export default function Resources() {
  const foundation = [
    {
      ...
      content:
        "Understanding your identity in Christ and what it means to be born again",
    },
    {
      title: "The Holy Spirit",
      content:
        "Discovering the person and work of the Holy Spirit in your life",
    },
    {
      title: "Prayer & Faith",
      content:
        "Building a strong foundation of prayer and developing unwavering faith",
    },
    {
      title: "The Word of God",
      content: "Learning to study and apply God's Word in your daily life",
    },
    {
      title: "Christian Living",
      content:
        "Practical guidance for living as a follower of Christ in today's world",
    },
    {
      title: "Spiritual Gifts",
      content:
        "Discovering and developing your spiritual gifts for ministry and service",
    },
  ];
  ...
  const getCardWidth = () => {
    if (isMobile) {
      return size.width ? size.width - 64 : 300; // fallback to 300px if width is null
    } else {
      return 400;
    }
  };
  ...
  const onDragEnd = () => {
    ...
    if (
      x <= -DRAG_BUFFER &&
      foundationIndex < foundation.length - (isMobile ? 1 : 2)
    ) {
      setFoundationIndex((prev) => prev + 1);
    } else if (x >= DRAG_BUFFER && foundationIndex > 0) {
      setFoundationIndex((prev) => prev - 1);
    }
  };
  ...
  const goToNext = () => {
    if (foundationIndex < foundation.length - (isMobile ? 1 : 2)) {
      setFoundationIndex((prev) => prev + 1);
    }
  };
  ...
  return (
    <section className="pt-[150px] font-body">
      <div className="flex flex-col gap-20 mb-50">
        <div className="flex flex-col lg:flex-row items-center justify-between px-8 lg:px-32 gap-16">
          <div className="flex flex-col lg:gap-1">
            ...
            <h1 className="flex items-center gap-2 text-[56px] leading-[72px] lg:text-[112px] lg:leading-[111px]">
              Center
              <CircleBadge
                drag={false}
                icon={{
          ...
          <Input icon="search" placeholder="Looking for edifying material?" />
        </div>
      ...
      <div
        className="flex flex-col items-center gap-32 px-8 lg:px-32 mb-50"
      ...
      >
        <div className="flex flex-col lg:flex-row lg:items-center justify-between lg:gap-32 gap-8">
          <h1 className="lg:text-[56px] text-[40px]">
            Are you new to our <br /> church or recently
          ...
          <p className="text-deep-blue-400 lg:w-[40%]">
            The Foundation School is the perfect place to start your journey of
            faith, growth, and service in BLW Lighthouse.
            <br />
            <br />
            Our aim is to raise up{" "}
            <span className="font-bold">bold and unapologetic</span>,
            Spirit-filled believers who will make disciples of all men,
            impacting the world with the character of the Spirit.
          </p>
        </div>
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
          <div className="border-yellow-400 border-[3px] rounded-2xl text-yellow-1100 p-8 text-center w-fit flex flex-col gap-4">
            <h1 className="text-[32px] leading-[40px] lg:text-[42px] lg:leading-[46px] whitespace-nowrap">
              FOUNDATION <br /> SCHOOL TERM 1
            </h1>
            <p className="text-xl">
              Foundation School Term 4 virtual classes will take place from{" "}
              <span className="font-bold">12 March - 2nd April 2025.</span>
            </p>
          </div>
          <svg
            width="40"
          ...
          <div className="border-aero-600 border-[3px] rounded-2xl text-deep-blue-600 p-8 text-center w-fit flex flex-col gap-4">
            ...
            <p className="text-xl">
              The classes consist of weekly sessions, Tuesday evenings from{" "}
              <span className="font-bold">18:30-20:00</span>. Lessons take place
              online, so anyone can attend from anywhere in the world.
              Recordings are available should you miss a session for any reason.
            </p>
          </div>
          <svg
            width="40"
          ...
          <div className="border-orange-600 border-[3px] rounded-2xl text-orange-1100 p-8 text-center w-fit flex flex-col gap-4">
            <h1 className="text-[32px] leading-[40px] lg:text-[42px] lg:leading-[46px] whitespace-nowrap">
              HOW LONG IS <br /> THE COURSE?
            </h1>
            <p className="text-xl">
              The program runs for <span className="font-bold">7 weeks</span>,
              with interactive classes and practical exercises to help you
        ...
        <div className="flex flex-col lg:flex-row relative items-center justify-between px-8 lg:px-32 lg:gap-0 gap-16">
          <div className="flex flex-col gap-16">
            <p className="text-deep-blue-400">
              As you embark on this exciting journey of faith with BLW
              Lighthouse, we want to personally welcome you to Foundation
              School, a place designed to equip and empower you for a life of
              spiritual growth, impact, and service.
              <br />
              <br />
              In this letter, you’ll find everything you need to know about the
              course, including what to expect, how to prepare, and the
          ...
          >
            <path
              d="M360.265 153.454V377.648H0.595703L0.595703 153.454C0.834038 153.239 1.07237 153.024 1.32154 152.809C46.2152 112.696 91.1089 72.5838 136.013 32.4714L168.709 4.53791C169.749 3.76721 174.31 0.558934 181.265 0.59478C188.436 0.621665 193.03 4.08087 194.005 4.84261C204.286 14.0552 214.567 23.2588 224.848 32.4714C269.752 72.5838 314.646 112.696 359.539 152.809C359.789 153.024 360.027 153.239 360.265 153.454Z"
              fill="#FFE3AA"
            />
            <path
              d="M323.192 64.1198L23.965 79.3607L30.8293 379.007L333.969 366.667L323.192 64.1198Z"
              fill="#E3F4FB"
            />
            <path
              d="M0.158203 385.741L0.158203 150.941L135.576 258.44L0.158203 385.741Z"
              fill="#FFBA2A"
            />
            <path
              d="M359.828 385.741V150.941L224.41 258.44L359.828 385.741Z"
              fill="#FFBA2A"
            />
            <path
              d="M0.15625 150.261H0.881531C0.632554 150.487 0.394402 150.714 0.15625 150.94L0.15625 150.261Z"
              fill="#FFEFC2"
            />
          </svg>
          ...
          >
            <path
              d="M634.685 230.53L762.803 571.052L216.512 776.59L88.3927 436.068C88.6318 435.605 88.8709 435.143 89.1265 434.674C134.391 348.093 179.656 261.512 224.938 174.925L258.635 113.814C259.774 112.049 264.868 104.569 275.452 100.649C286.361 96.5916 295.314 99.2208 297.23 99.8206C318.11 107.938 338.985 116.042 359.865 124.16C450.992 159.424 542.103 194.694 633.213 229.965C633.715 230.149 634.2 230.339 634.685 230.53Z"
              fill="#FFE3AA"
            />
            <motion.path
              ref={letterRef}
              style={{ y: position }}
              d="M527.327 116.028L81.5489 310.175L263.212 761.377L716.591 569.399L527.327 116.028Z"
              fill="#E3F4FB"
            />
            <motion.path
            ...
            <motion.path
              ...
              whileInView={{ pathLength: 1 }}
              transition={{ duration: 1, ease: "easeInOut", delay: 1 }}
              d="M258.191 468.334C258.892 465.997 263.92 463.927 265.984 463.337C270.28 462.11 269.821 463.803 271.577 467.509C275.066 474.874 284.327 473.16 289.959 469.847C297.817 465.225 304.841 457.955 310.45 450.914C312.652 448.151 318.408 442.633 319.206 439.041C319.939 435.744 327.436 436.978 330.162 436.978C337.444 436.978 340.793 434.889 346.207 429.369C350.529 424.962 352.929 420.064 357.209 416.395C359.865 414.118 364.059 415.468 366.698 413.416C371.569 409.627 375.966 400.672 382.33 400.672C387.258 400.672 392.051 402.202 397.182 401.314C402.274 400.432 411.362 393.536 413.96 389.12C416.959 384.023 428.989 387.469 433.947 387.469C441.316 387.469 448.838 378.918 454.576 375.092"
              stroke="#ADDFF5"
              strokeWidth="3.25386"
              strokeLinecap="round"
            />
            <path
              d="M220.473 789.132L86.293 432.501L353.407 518.392L220.473 789.132Z"
              fill="#FFBA2A"
            />
            <path
              d="M766.764 583.594L632.585 226.963L488.334 467.627L766.764 583.594Z"
              fill="#FFBA2A"
            />
            <path
              d="M220.471 789.132C258.508 682.191 296.528 575.257 334.565 468.316C344.069 443.353 353.574 418.39 363.078 393.427C364.074 391.282 368.557 382.227 379.141 378.306C390.061 374.28 399.666 378.591 401.73 379.584C424.32 392.246 446.903 404.889 469.493 417.551C568.588 472.896 667.668 528.248 766.763 583.594L220.471 789.132Z"
              fill="#FFD67F"
            />
            <path
              d="M85.9043 431.469L87.0059 431.054C86.757 431.54 86.5245 432.02 86.292 432.499L85.9043 431.469Z"
              fill="#FFEFC2"
            />
            <g clipPath="url(#clip0_2518_1517)">
              <motion.path
                initial={{ pathLength: 0 }}
                whileInView={{ pathLength: 1 }}
                transition={{ duration: 1, ease: "easeInOut", delay: 1 }}
            ...
            <defs>
              <clipPath id="clip0_2518_1517">
                <rect
                  ...
                  height="36.1754"
                  fill="white"
                  transform="translate(456.416 346.75) rotate(-24.8964)"
                />
              </clipPath>
            </defs>
          </svg>
      ...
      <div className="mb-50 lg:pl-[127px] px-8 flex flex-col lg:flex-row lg:items-center lg:justify-between overflow-x-hidden gap-10">
        <div className="flex flex-col gap-4 shrink-0 lg:w-2/5">
          <h2 className="lg:text-[56px] text-[40px] leading-14">
            What
            <div className="relative inline-block ml-2 w-fit h-fit">
              <p>You&apos;ll</p>
              <svg
                className="absolute left-2 -bottom-2 w-full"
                width="119"
                height="13"
                viewBox="0 0 119 13"
                fill="none"
          ...
          <p className="text-deep-blue-400 lg:w-[60%] w-full md:w-[30%]">
            Topics covered in Foundation School.
          </p>
        </div>
        <div className="py-2 flex flex-col gap-10 overflow-hidden relative">
          <motion.div
            ...
            animate={{
              translateX: -foundationIndex * totalCardWidth,
            }}
            transition={{
              type: "spring",
              mass: 3,
            ...
            onDragEnd={onDragEnd}
            className="flex items-center gap-32 cursor-grab active:cursor-grabbing w-max relative"
          >
