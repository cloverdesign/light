    ...
    const scope = useMotionTimeline(
        [
            [
                ...
                [".join-btn", { scale: 1, opacity: 1 }, { duration: 0.8, ease: "easeInOut", delay: 0.2 }],
            ],
            [
                [".badge-1", { scale: 1 }, { duration: 1, ease: "easeInOut", delay: 0.2, type: spring, bounce: 0.5 }],
                [".badge-2", { scale: 1 }, { duration: 1, ease: "easeInOut", delay: 0.3, type: spring, bounce: 0.5 }],
            ],
        ]
    )
            ...
            >
                ...
                <div className="flex flex-col lg:items-start items-center justify-center gap-10 text-yellow-100 relative z-[2] h-full w-full lg:pl-10">
                    ...
                    <MotionButton
                        ...
                        variant="secondary-juicy" className="join-btn ml-4 w-fit">
                        Join The BLW
                    </MotionButton>
                </div>
            </div>
                ...
                <div className='px-8 lg:px-32 my-100 flex flex-col gap-14 relative overflow-x-hidden'>
                    <div className='flex flex-col lg:flex-row items-center justify-between gap-8 h-max'>
                        <MotionImage
                            ...
                            ref={missionRef}
                            src={mission} alt="Hand on the bible" className='rounded-xl h-[200px] lg:h-full w-full object-cover'
                        />
                        <motion.div
                    ...
                    <div
                        className='flex flex-col lg:flex-row items-center justify-between gap-8 h-max'
                    >
                        <motion.div
                        ...
                        <div className="overflow-y-hidden">
                            ...
                            >
                                ...
                                <motion.span
                                    ...
                                    whileInView={{ scale: 1 }}
                                    viewport={{ once: true }}
                                    transition={{ duration: 0.8, ease: "easeInOut", delay: 0.7, type: spring, bounce: 0.5 }}
                    ...
                    <div className='flex flex-col h-full items-center gap-8'>
                        <div className='lg:flex flex-col items-center gap-3 text-center hidden'>
                            ...
                            <motion.p
                                ...
                                A small group of passionate believers came together with a shared dream: to spread the divine presence of God and demonstrate the character of the Spirit in their community.
                            </motion.p>
                        </div>
                                ...
                                <div className='hidden lg:flex flex-col items-center absolute -z-[1]'>
                                    ...
                                    >
                                        <motion.path
                                            ...
                                            transition={{ duration: 0.8, ease: "easeInOut", delay: 0.7 }}
                                            d="M1.5 1.5V501.5" stroke="#011C31" strokeWidth="3" strokeLinecap="round"
                                        />
                                    </svg>
                                </div>
                            </div>
